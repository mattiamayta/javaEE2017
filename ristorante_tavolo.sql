...
CREATE TABLE `tavolo` (
  ...
  `Cameriere_idCameriere` int(11) NOT NULL,
  PRIMARY KEY (`idTavolo`),
  KEY `fk_Tavolo_Cameriere1_idx` (`Cameriere_idCameriere`),
  CONSTRAINT `fk_Tavolo_Cameriere1` FOREIGN KEY (`Cameriere_idCameriere`) REFERENCES `cameriere` (`idCameriere`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tavolo` VALUES (1,1),(4,1),(2,2),(3,3);
